...
vec3 sampleOffsetDirections[20] = 
{
	...
	vec3(1.0, 0.0, 1.0), vec3(-1.0, 0.0, 1.0), vec3(1.0, 0.0, -1.0), vec3(0.0, 1.0, -1.0),
...
float CalcOmniShadowFactor(PointLight light, int shadowIndex)
{
	...
	{
		closestDepth = texture(omniShadowMaps[shadowIndex].shadowMap, fragToLight + vec3(sampleOffsetDirections[i]) * discRadius).r;
